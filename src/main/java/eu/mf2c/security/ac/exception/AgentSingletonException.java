...
/**
 * Errors associated with the {@link eu.mf2c.security.ac.exception.AgentSingletonException 
 * <em>AgentSingletonException</em>} object.
 * <p>
 ...
 */
public class AgentSingletonException extends Exception {
	 ...
	 */
	public AgentSingletonException(String message) {
		super(message);
	}
	 ...
	 */
	public AgentSingletonException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause {@link Throwable} cause
	 */
	public AgentSingletonException(Throwable cause) {
		super(cause);
	}
