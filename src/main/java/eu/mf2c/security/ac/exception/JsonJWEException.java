...
/**
 * Errors associated with the {@link eu.mf2c.security.ac.exception.JsonJWEException 
 * <em>JsonJWEException</em>} object.
 * <p>
 ...
 */
public class JsonJWEException extends Exception {
	 ...
	 */
	public JsonJWEException(String message) {
		super(message);
	}
	 ...
	 */
	public JsonJWEException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause {@link Throwable} cause
	 */
	public JsonJWEException(Throwable cause) {
		super(cause);
	}
