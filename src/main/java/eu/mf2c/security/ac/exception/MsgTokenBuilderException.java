...
/**
 * Errors associated with the {@link eu.mf2c.security.ac.exception.MsgTokenBuilderException 
 * <em>MsgTokenBuilderException</em>} object.
 * <p>
 ...
 */
public class MsgTokenBuilderException extends Exception {
	 ...
	 */
	public MsgTokenBuilderException(String message) {
		super(message);		
	}
	 ...
	 */
	public MsgTokenBuilderException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause {@link Throwable} cause
	 */
	public MsgTokenBuilderException(Throwable cause) {
		super(cause);
	}
