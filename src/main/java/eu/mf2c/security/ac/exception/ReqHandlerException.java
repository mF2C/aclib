...
/**
 * Errors associated with the {@link eu.mf2c.security.ac.exception.ReqHandlerException 
 * <em>ReqHandlerException</em>} object.
 * <p>
 ...
 */
public class ReqHandlerException extends Exception {
	 ...
	 */
	public ReqHandlerException(String message) {
		super(message);
	}
	 ...
	 */
	public ReqHandlerException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause {@link Throwable} cause
	 */
	public ReqHandlerException(Throwable cause) {
		super(cause);
	}
